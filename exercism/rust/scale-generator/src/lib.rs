...
/// Scale abstraction.
///
/// The pitches the scale contains are stored as bits in a `u16` bitmask, where the bits from right
/// to left represents the pitches C, C sharp/D flat, D, etc. The `tonic` field represents the
/// pitch class value of the scale's tonic (or key center). The lean represents whether the pitch
/// names of the scale are to be represented as sharps or as flats.
pub struct Scale {
    pub tonic: u16,
    pub pitches: u16,
    pub lean: Lean,
